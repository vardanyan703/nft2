...
@include('cabinet.layouts.includes.header')
<body class="antialiased" style="position: relative; min-height: 100%; top: 0px;">
...
<img src="" width="37px" height="14px" style="padding-right: 3px" alt="Google Переводчик">
    ...
    <div class="skiptranslate goog-te-gadget" dir="ltr" style="">
        ...
        Технологии <span style="white-space:nowrap"><a class="goog-logo-link" href="/translate.google.com.html"
                                                       target="_blank">
{{--                <img--}}
{{--                        src="./www.gstatic.com/images/branding/googlelogo/1x/googlelogo_color_42x16dp.png" width="37px" height="14px"--}}
{{--                        style="padding-right: 3px" alt="Google Переводчик">--}}
                Переводчик</a></span></div>
</div>
<style type="text/css">
    #goog-gt-tt {
...
<div class="page">
    @include('cabinet.layouts.includes.navbar')
    @yield('cabinet-content')
</div>

@include('cabinet.layouts.includes.footer')
