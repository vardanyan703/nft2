                                            ...
                                            <div class="card-body">
                                                <form action="{{ route('cabinet.buy-token.payment.confirm') }}"
                                                    ...
                                                    <div class="form-footer mt-3 pt-lg-2" style="margin-top: 1.1rem;">
                                                        ...
                                                        <button class="btn btn-big btn-yellow btn-main text-uppercase mb-2 loading d-none"
                                            ...
                                            <table class="table table-new ">
                                                @foreach($transactions as $transaction)
                                                    ...
                                                    <tr class="table-white">
                                                        ...
                                                        <th><span>Status</span> <br> {{ $transaction->status_text }}
                                                        </th>
                                                        <th>
                                                        ...
                                                        <th class="table-btn-th" style=" vertical-align: center;">
                                                            <button type="button"
                                                                    class="btn btn-big btn-yellow btn-main text-uppercase mb-2 open-details"
