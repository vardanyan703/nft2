                                                ...
                                                <form action="{{ route('cabinet.buy-token.payment.confirm') }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 text-center img_plans">
                                                            <img src="{{ $tariff->attachment[0]->url() }}" width="209" alt="">
                                                        </div>
...
{{--                                                            <label class="form-label" translate="yes"> Select a paymentsystem</label>--}}
                                                        ...
                                                        <div class="col-12" translate="no">
                                                            <input class="form-control form-input-main" autocomplete="off"
                                                                   name="m_amount"
                                                                   id="tdep_minmax" type="text" placeholder="Enter amount (USD)"
                                                                   inputmode="text"
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="form-footer mt-3 pt-2" style="margin-top: 1.1rem;">
                                                        <button type="button" name="submit" id="form"
                                                                ...
                                                                data-key="{{$key}}"
                                                                class="btn btn-big btn-yellow btn-main text-uppercase mb-2 buy" style="width: 100%;">
                                                             Buy a token
                                                        </button>
                                                        ...
                                                        <button class="btn btn-primary mb-2 loading d-none"
                                        ...
                                        <table class="table text-center">
                                            @foreach($transactions as $transaction)
                                                ...
                                                <tr class="table-white">
                                                    ...
                                                    <th scope="row">
                                                        Payment system <br> {{ $transaction->currency1 }}
                                                    </th>
