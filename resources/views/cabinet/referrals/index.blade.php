                ...
                <div class="row row-deck row-cards">
                    ...
                    <div class="col-md-12">
                        <div class="card card-grey card-tokens">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="title title-small text-uppercase title-line mb-xl-4 mb-3">Referral link</h4>
                                    <form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-4">
                                    <div class="card card-grey card-tokens">
                                            ...
                                            <div class="form-footer">
                                                <button type="submit" class="w-full btn btn-yellow btn-big text-uppercase btn-main btn-primary">
                                                    Apply
                                                </button>
                                            </div>
                                    </div>
