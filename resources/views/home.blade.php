...
@section('content')
    <main>
            ...
            <div class="home-banner__bg">
                <div class="wrapper">
                    <div class="home-banner__inner">
                        <h1 class="title title-big title-line title-line__white  d-tab__none">
                        ...
                        <p class="home-desc">Earn up to 1.3% daily from the investment pool, own some of the best NFTs on Binance, and
        ...
        <section class="section-bg section-grower" id="about-us">
            <div class="wrapper">
                <div class="section-grower__inner">
                    ...
                    <div class="section-grower__right">
                        ...
                        <div class="desc">NFT Grower is an NFT collection of 11,111 unique monkey characters powered by the Binance
                            blockchain.
                        </div>
                        <div class="section-grower__list">
                            <div class="section-grower__item">
                                <div class="title-line title-line__dark mb-md-3 mb-5"></div>
                                <div class="desc">By purchasing NFT Grower tokens on Binance, you become a co-owner of the NFT Grower
                                    Metaverse with many gaming and financial mechanics, where the income from the project will be
                                    distributed among all NFT owners.
                                </div>
                            </div>
                            <div class="section-grower__item">
                                <div class="title-line title-line__dark mb-md-3 mb-5"></div>
                                <div class="desc">By purchasing NFT Grower tokens in your personal account, you get access to the
                                    investment pool and can earn up to 1.3% per day from the value of your NFTs for the duration of the NFT.
                                </div>
                            </div>
                        </div>
                        <div class="desc mb-7">Each member of the NFT Grower Сommunity has access to a 4-level referral program to
                            invite
                    ...
                    <div class="swiper-arrows">
                        <div class="swiper-arrow swiper-button-prev">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.53944 9.39793C3.31969 9.17818 3.31969 8.82231 3.53944 8.60256L11.2269 0.915057C11.4467 0.695307 11.8026 0.695307 12.0223 0.915057L14.4598 3.35256C14.6796 3.57231 14.6796 3.92818 14.4598 4.14793L9.60769 9.00006L14.4602 13.8522C14.6799 14.0719 14.6799 14.4278 14.4602 14.6476L12.0227 17.0851C11.9128 17.1953 11.7688 17.2501 11.6248 17.2501C11.4808 17.2501 11.3368 17.1953 11.2269 17.0854L3.53944 9.39793Z"
                                      fill="#303640"/>
                            </svg>
                        </div>
                        <div class="swiper-arrow swiper-button-next">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.4606 9.39793C14.6803 9.17818 14.6803 8.82231 14.4606 8.60256L6.77306 0.915057C6.55331 0.695307 6.19744 0.695307 5.97769 0.915057L3.54019 3.35256C3.32044 3.57231 3.32044 3.92818 3.54019 4.14793L8.39231 9.00006L3.53981 13.8522C3.32006 14.0719 3.32006 14.4278 3.53981 14.6476L5.97731 17.0851C6.08719 17.1953 6.23119 17.2501 6.37519 17.2501C6.51919 17.2501 6.66319 17.1953 6.77306 17.0854L14.4606 9.39793Z"
                                      fill="#303640"/>
                            </svg>
                        </div>
                    </div>
                ...
                <div class="wrapper wrapper-tokens">
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper tokens__list">
                            ...
                            <div class="swiper-slide tokens__item">
                                <div class="tokens__img">
                                    <img src="images/tokens-2.png" alt="">
                                </div>
                                <div class="tokens__content">
                                    <div class="tokens__title">Eduardo</div>
                                    <ul class="tokens-info__list">
                            ...
                            <div class="swiper-slide tokens__item">
                                <div class="tokens__img">
                                    <img src="images/tokens-3.png" alt="">
                                </div>
                                <div class="tokens__content">
                                    <div class="tokens__title">Eduardo</div>
                                    <ul class="tokens-info__list">
                            ...
                            <div class="swiper-slide tokens__item">
                                <div class="tokens__img">
                                    <img src="images/tokens-4.png" alt="">
                                </div>
                                <div class="tokens__content">
                                    <div class="tokens__title">Eduardo</div>
                                    <ul class="tokens-info__list">
                            ...
                            <div class="swiper-slide tokens__item">
                                <div class="tokens__img">
                                    <img src="images/tokens-5.png" alt="">
                                </div>
                                <div class="tokens__content">
                                    <div class="tokens__title">Eduardo</div>
                                    <ul class="tokens-info__list">
            ...
            <div class="wrapper">
                <div class="faq__inner">
                    ...
                    <div class="yellow-bg__solid mb-4">
                        <div class="yellow-bg__solid-inner">
                            ...
                            <div class="faq__info-btns">
                                <button class="btn btn-primary tab" data-item=".tab-1">NFT Grower</button>
                            ...
                            <div class="tab-contents">
                                <div class="tab-content tab-1" style="display:block;">
                                    <ul class="progress">
                                        ...
                                        <li class="progress__item">
                                            ...
                                            <div class="progress__text">Choose the tokens that suits you and buy them</div>
                                        </li>
                                        <li class="progress__item">
                                            <div class="progress__number">04</div>
                                            <div class="progress__text">The tokens is available in the Your Tokens section</div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tab-content tab-2">
                                    <ul class="progress">
                                        ...
                                        <li class="progress__item">
                                            <div class="progress__number">02</div>
                                            <div class="progress__text">Find the NFT Grower collection using the official links</div>
                                        </li>
                                        <li class="progress__item">
                                            <div class="progress__number">03</div>
                                        ...
                                        <li class="progress__item">
                                            <div class="progress__number">04</div>
                                            <div class="progress__text">The tokens is available in the Your Binance account</div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="yellow-bg__solid">
                        <div class="yellow-bg__solid-inner">
                            <p class="desc-info">You can buy NFT Grower tokens on the official website using all the leading
                                chains/cryptocurrencies (Bitcoin, Ethereum, BNB, TRON, HECO, MATIC, AVAX, OKT, EOS, FTM, Polkadot, Cosmos,
                                IOST, etc..</p>
                            <ul class="coin__list">
                                <li class="coin__item ">
                    ...
                    <div class="accordion__list">
                        <div class="accordion">
                            <div class="accordion__item">
                                ...
                                <div class="accordion__content" style="display: none;">
                                    <div class="accordion__body">
                                        <div class="desc">We started our journey with a big idea, which is becoming more and more real every
                                            day.
                                            Each member of the team is a professional with many years of experience in their field. We have united
                                            and invite to our team those who believe in the future of cryptocurrencies, who know that in the next
                                            5-7 years WEB 3.0 will replace the usual Internet and who are ready to be on the wave and make a big
                                            and
                                            useful project for everyone around the world.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion__item">
                                <div class="accordion__header accordion-toggle" data-show=".accordion__content"
                                     data-parent=".accordion__item">
                                    <div class="accordion__title">How can i Earn on an NFT token?</div>
                                    <div class="accordion__arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.021 3.14638C12.8256 2.95104 12.5093 2.95104 12.314 3.14638L8.00065 7.45971L3.68765 3.14638C3.49231 2.95104 3.17598 2.95104 2.98065 3.14638L0.81398 5.31304C0.618647 5.50838 0.618647 5.82471 0.81398 6.02004L7.64731 12.8534C7.74465 12.9514 7.87265 13 8.00065 13C8.12865 13 8.25665 12.9514 8.35431 12.8537L15.1876 6.02038C15.383 5.82505 15.383 5.50871 15.1876 5.31338L13.021 3.14638Z"
                                                  fill="#14151B"/>
                            ...
                            <div class="accordion__item">
                                <div class="accordion__header accordion-toggle" data-show=".accordion__content"
                                     data-parent=".accordion__item">
                                    <div class="accordion__title">How do i register?</div>
                                    <div class="accordion__arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.021 3.14638C12.8256 2.95104 12.5093 2.95104 12.314 3.14638L8.00065 7.45971L3.68765 3.14638C3.49231 2.95104 3.17598 2.95104 2.98065 3.14638L0.81398 5.31304C0.618647 5.50838 0.618647 5.82471 0.81398 6.02004L7.64731 12.8534C7.74465 12.9514 7.87265 13 8.00065 13C8.12865 13 8.25665 12.9514 8.35431 12.8537L15.1876 6.02038C15.383 5.82505 15.383 5.50871 15.1876 5.31338L13.021 3.14638Z"
                                                  fill="#14151B"/>
                            ...
                            <div class="accordion__item">
                                <div class="accordion__header accordion-toggle" data-show=".accordion__content"
                                     data-parent=".accordion__item">
                                    <div class="accordion__title">After registration, what should i do?</div>
                                    <div class="accordion__arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.021 3.14638C12.8256 2.95104 12.5093 2.95104 12.314 3.14638L8.00065 7.45971L3.68765 3.14638C3.49231 2.95104 3.17598 2.95104 2.98065 3.14638L0.81398 5.31304C0.618647 5.50838 0.618647 5.82471 0.81398 6.02004L7.64731 12.8534C7.74465 12.9514 7.87265 13 8.00065 13C8.12865 13 8.25665 12.9514 8.35431 12.8537L15.1876 6.02038C15.383 5.82505 15.383 5.50871 15.1876 5.31338L13.021 3.14638Z"
                                                  fill="#14151B"/>
                            ...
                            <div class="accordion__item">
                                <div class="accordion__header accordion-toggle" data-show=".accordion__content"
                                     data-parent=".accordion__item">
                                    <div class="accordion__title">How to buy a token?</div>
                                    <div class="accordion__arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.021 3.14638C12.8256 2.95104 12.5093 2.95104 12.314 3.14638L8.00065 7.45971L3.68765 3.14638C3.49231 2.95104 3.17598 2.95104 2.98065 3.14638L0.81398 5.31304C0.618647 5.50838 0.618647 5.82471 0.81398 6.02004L7.64731 12.8534C7.74465 12.9514 7.87265 13 8.00065 13C8.12865 13 8.25665 12.9514 8.35431 12.8537L15.1876 6.02038C15.383 5.82505 15.383 5.50871 15.1876 5.31338L13.021 3.14638Z"
                                                  fill="#14151B"/>
                        ...
                        <div class="accordion">
                            <div class="accordion__item">
                                <div class="accordion__header accordion-toggle" data-show=".accordion__content"
                                     data-parent=".accordion__item">
                                    <div class="accordion__title">Bought NTFs but they didn’t show up in the “Your tokens” section?</div>
                                    <div class="accordion__arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.021 3.14638C12.8256 2.95104 12.5093 2.95104 12.314 3.14638L8.00065 7.45971L3.68765 3.14638C3.49231 2.95104 3.17598 2.95104 2.98065 3.14638L0.81398 5.31304C0.618647 5.50838 0.618647 5.82471 0.81398 6.02004L7.64731 12.8534C7.74465 12.9514 7.87265 13 8.00065 13C8.12865 13 8.25665 12.9514 8.35431 12.8537L15.1876 6.02038C15.383 5.82505 15.383 5.50871 15.1876 5.31338L13.021 3.14638Z"
                                                  fill="#14151B"/>
                            ...
                            <div class="accordion__item">
                                <div class="accordion__header accordion-toggle" data-show=".accordion__content"
                                     data-parent=".accordion__item">
                                    <div class="accordion__title">After the token is closed, what happens?</div>
                                    <div class="accordion__arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.021 3.14638C12.8256 2.95104 12.5093 2.95104 12.314 3.14638L8.00065 7.45971L3.68765 3.14638C3.49231 2.95104 3.17598 2.95104 2.98065 3.14638L0.81398 5.31304C0.618647 5.50838 0.618647 5.82471 0.81398 6.02004L7.64731 12.8534C7.74465 12.9514 7.87265 13 8.00065 13C8.12865 13 8.25665 12.9514 8.35431 12.8537L15.1876 6.02038C15.383 5.82505 15.383 5.50871 15.1876 5.31338L13.021 3.14638Z"
                                                  fill="#14151B"/>
                            ...
                            <div class="accordion__item">
                                <div class="accordion__header accordion-toggle" data-show=".accordion__content"
                                     data-parent=".accordion__item">
                                    <div class="accordion__title">How can i reinvest?</div>
                                    <div class="accordion__arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.021 3.14638C12.8256 2.95104 12.5093 2.95104 12.314 3.14638L8.00065 7.45971L3.68765 3.14638C3.49231 2.95104 3.17598 2.95104 2.98065 3.14638L0.81398 5.31304C0.618647 5.50838 0.618647 5.82471 0.81398 6.02004L7.64731 12.8534C7.74465 12.9514 7.87265 13 8.00065 13C8.12865 13 8.25665 12.9514 8.35431 12.8537L15.1876 6.02038C15.383 5.82505 15.383 5.50871 15.1876 5.31338L13.021 3.14638Z"
                                                  fill="#14151B"/>
                            ...
                            <div class="accordion__item">
                                <div class="accordion__header accordion-toggle" data-show=".accordion__content"
                                     data-parent=".accordion__item">
                                    <div class="accordion__title">How can i withdraw funds?</div>
                                    <div class="accordion__arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.021 3.14638C12.8256 2.95104 12.5093 2.95104 12.314 3.14638L8.00065 7.45971L3.68765 3.14638C3.49231 2.95104 3.17598 2.95104 2.98065 3.14638L0.81398 5.31304C0.618647 5.50838 0.618647 5.82471 0.81398 6.02004L7.64731 12.8534C7.74465 12.9514 7.87265 13 8.00065 13C8.12865 13 8.25665 12.9514 8.35431 12.8537L15.1876 6.02038C15.383 5.82505 15.383 5.50871 15.1876 5.31338L13.021 3.14638Z"
                                                  fill="#14151B"/>
                            ...
                            <div class="accordion__item">
                                <div class="accordion__header accordion-toggle" data-show=".accordion__content"
                                     data-parent=".accordion__item">
                                    <div class="accordion__title">What is affiliate program?</div>
                                    <div class="accordion__arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.021 3.14638C12.8256 2.95104 12.5093 2.95104 12.314 3.14638L8.00065 7.45971L3.68765 3.14638C3.49231 2.95104 3.17598 2.95104 2.98065 3.14638L0.81398 5.31304C0.618647 5.50838 0.618647 5.82471 0.81398 6.02004L7.64731 12.8534C7.74465 12.9514 7.87265 13 8.00065 13C8.12865 13 8.25665 12.9514 8.35431 12.8537L15.1876 6.02038C15.383 5.82505 15.383 5.50871 15.1876 5.31338L13.021 3.14638Z"
                                                  fill="#14151B"/>
        ...
        <section class="started">
            <div class="wrapper">
                <div class="started__inner">
                    ...
                    <p class="desc text-center">Join our community, invite your friends and buy NFT Grower tokens to earn every day and be part of a project that creates the future</p>
                    <div class="started__info-btns">
                        <button class="btn btn-primary">Get Started</button>
                        <button class="btn ">Affiliate  Presentation</button>
                    </div>
                </div>
            </div>
