...
@section('content')
    ...
    <main class="yellow-bg">
        <div class="wrapper wrapper-p">
            <form class="forms-section bg-white" action="{{ route('login') }}" method="post">
                @csrf
                <div class="effects">
                ...
                <div class="form-item">
                    <button class="btn btn-primary" type="submit">Log in to account</button>
                </div>
                <div class="title title-small-1 mt-11 pb-0 mb-0">Don't have a NFT Grower Account? <a
                        href="{{ route('register') }}"
                        class="title-small__link">New
                        Account</a></div>
            </form>
